...
unsigned int CDECL get_sizeof_volinfo_struct();
unsigned int CDECL get_sizeof_dirinfo_struct();
unsigned int CDECL get_sizeof_dirent_struct();
unsigned int CDECL get_sizeof_fileinfo_struct();
unsigned int CDECL get_sizeof_scratch_sector();
